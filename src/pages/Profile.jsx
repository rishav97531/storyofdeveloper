...
export default function Profile() {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-color)', color: 'var(--text-color)' }}>
      ...
      >
        <h1 style={{ fontSize: '3rem', color: 'var(--accent-1)', marginBottom: '1rem' }}>User Profile</h1>
        <div style={{ background: 'var(--glass-bg)', border: '1px solid var(--glass-border)', borderRadius: '20px', padding: '2rem', backdropFilter: 'blur(10px)' }}>
          <p style={{ fontSize: '1.2rem', color: 'var(--text-muted)' }}>This is where the user profile information will be displayed.</p>
        </div>
      </motion.div>
    </div>
  );
